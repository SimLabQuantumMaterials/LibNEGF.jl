...
"""
const ArrayOrLUUnder_ = Union{ArrayWithType,CpuLU,Nothing}
const ArrayOrLU_ = Matrix{ArrayOrLUUnder_}
const ArrayOrLUView_ = SubArray{ArrayOrLUUnder_,2,ArrayOrLU_,Tuple{UnitRange{Int},UnitRange{Int}},false}
